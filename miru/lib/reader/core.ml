...
and readtable =
  {macro: (char, reader_fn) Hashtbl.t; dispatch: (char, reader_fn) Hashtbl.t}
...
let copy rt = {macro= Hashtbl.copy rt.macro; dispatch= Hashtbl.copy rt.dispatch}
